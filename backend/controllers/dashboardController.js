...
export async function getDashboardOverview(req, res) {
    ...
    try {
        ...
        const monthlyIncome = incomes.reduce((acc, cur) => acc + cur.amount, 0);
        const monthlyExpense = expenses.reduce((acc, cur) => acc + cur.amount, 0);
        const savings = monthlyExpense - monthlyIncome;
